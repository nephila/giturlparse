...
VALID_PARSE_URLS = (
    ...
    # Userless SCP-style URLs (no user@ prefix)
    (
        "SSH",
        (
    ...
    # Assembla userless SCP-style
    (
        "SSH",
        (
            "git.assembla.com:SomeRepoID.git",
            {
                "host": "git.assembla.com",
                "resource": "git.assembla.com",
                "user": "git",
                "port": "",
                "repo": "SomeRepoID",
                "name": "SomeRepoID",
    ...
    (
        "SSH",
        (
            "alice@host.org:9999/Org/Repo.git",
            {
                "host": "host.org",
                "resource": "host.org",
                "user": "alice",
    ...
    (
        "SSH",
        (
            "bob@git.assembla.com:SomeRepoID.git",
            {
                "host": "git.assembla.com",
                "resource": "git.assembla.com",
                "user": "bob",
    ...
    (
        "SSH",
        (
            "ssh://alice@host.org/Org/Repo.git",
            {
                "host": "host.org",
                "resource": "host.org",
                "user": "alice",
    ...
    # Unknown host falls through to gitlab
    (
        "SSH",
        (
...
INVALID_PARSE_URLS = (
    ...
    # False positives prevented by base domain requiring FQDN
    ("Generic host:path too generic", "foo:bar"),
    ("Single-letter host:path too generic", "a:b"),
    ("Localhost without path structure", "localhost:repo"),
    ("Windows path not a git URL", "C:\\repo"),
    # Structural invalidity
    ("Missing repo path after colon-slash", "host:/repo.git"),
    ("Missing host before colon", ":Org/Repo.git"),
)
